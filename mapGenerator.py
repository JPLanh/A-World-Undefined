...
def initialize(TILE_SIZE):
  ...
  pygame.draw.rect(GRASS, (10, 100, 50), (0, 0, TILE_SIZE, TILE_SIZE), 2)
  GROUND = pygame.Surface((TILE_SIZE, TILE_SIZE))
  GROUND.fill((90, 40, 20))
  pygame.draw.rect(GROUND, (110, 100, 50), (0, 0, TILE_SIZE, TILE_SIZE), 2)
  WATER = pygame.Surface((TILE_SIZE, TILE_SIZE))
  WATER.fill((40, 70, 170))
  pygame.draw.rect(WATER, (80, 80, 190), (0, 0, TILE_SIZE, TILE_SIZE), 2)
  FLOOR = pygame.Surface((TILE_SIZE, TILE_SIZE))
  FLOOR.fill((120, 120, 100))
  pygame.draw.rect(FLOOR, (20, 20, 20), (0, 0, TILE_SIZE, TILE_SIZE), 2)  

  TEXTURES = {'1': GRASS, '2': GROUND, '3': WATER, '4': FLOOR}

  # The map is a list of lists which contain pg.Rects and the tile_type.
  MAP_DATA = [[(pygame.Rect(TILE_SIZE*x, TILE_SIZE*y, TILE_SIZE, TILE_SIZE), '2')
               for x in range(100)]
              for y in range(100)]
  ...
  BACKGROUND = pygame.Surface((TILE_SIZE*128, TILE_SIZE*128))
